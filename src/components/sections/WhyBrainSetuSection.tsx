            ...
            {benefits.map((benefit, idx) => {
              ...
              return (
                <ScrollReveal key={idx} delay={idx * 100}>
                  <div
                    className="p-6 rounded-2xl bg-white border border-slate-200/70 shadow-sm hover:border-slate-300 hover:shadow-card hover:-translate-y-1 transition-all duration-300 space-y-3 group"
                  >
                    <div className="w-10 h-10 rounded-xl bg-slate-100 text-brand-primary flex items-center justify-center transition-all duration-300 group-hover:scale-105 group-hover:bg-brand-primary-subtle group-hover:text-brand-secondary">
