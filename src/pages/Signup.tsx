...
export const Signup: React.FC = () => {
  ...
  const [grade, setGrade] = useState('Grade 3–4 (Bridge Explorers)');
  ...
  return (
    <>
      <SEO
        title="Create Account — BrainSetu Academy Student & Parent Portal"
              ...
              <div className="grid grid-cols-2 gap-3 pt-1">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2.5 text-sm border border-slate-300 rounded-xl text-slate-800 bg-white focus:outline-none focus:ring-2 focus:ring-brand-secondary"
                  >
                    <option value="Grade 1–2 (Foundations)">Grade 1–2</option>
                    <option value="Grade 3–4 (Bridge Explorers)">Grade 3–4</option>
                    <option value="Grade 5 (Mastery Champions)">Grade 5</option>
                    <option value="Middle School (Grades 6–8)">Grades 6–8</option>
                    <option value="Secondary (Grades 9–10)">Grades 9–10</option>
                  </select>
                </div>
              </div>
